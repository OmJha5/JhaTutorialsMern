            ...
            <div className="w-full bg-[#f1f1f1]">
                <div className='my-10 max-w-7xl mx-auto rounded-md shadow-2xl !bg-white sm:p-10 max-sm:p-5'>
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-sm text-gray-600">To stay updated with the latest job opportunities and education news, follow and share Jha Tutorials!</p>
                        <p className='my-2'><span className='text-sm'>Official YT Channel</span> : <a href="https://youtube.com/@jhatutorials?feature=shared" target='_blank' className='text-blue-500 underline'>Jha Tutorials</a></p>
                    </div>
